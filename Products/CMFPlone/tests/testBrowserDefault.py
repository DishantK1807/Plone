...
class TestPortalBrowserDefault(PloneTestCase.PloneTestCase):
    ...
    def afterSetUp(self):
        self.setRoles(['Manager'])
        self.portal.invokeFactory('Document', 'defaultpage',
                                  title = 'Hello')
        self.portal.setDefaultPage('defaultpage')
    ...
    def testDefaultViews(self):
        ...
        self.assertEqual(self.portal.getDefaultPage(), 'defaultpage')
        self.assertEqual(self.portal.defaultView(), 'defaultpage')
        ...
        self.assertEqual(self.portal.__browser_default__(None), (self.portal, ['defaultpage',]))
