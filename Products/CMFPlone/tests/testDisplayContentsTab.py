...
class TestDisplayContentsTab(PloneTestCase.PloneTestCase):
    ...
    def testDisplayContentsTab(self):
        ...
        view = getMultiAdapter((self.folder, self.app.REQUEST), name='plone')
        self.failUnless(view.displayContentsTab())

    def testAnonymous(self):
        # Anonymous should not see the tab
        self.logout()
        view = getMultiAdapter((self.folder, self.app.REQUEST), name='plone')
        self.failIf(view.displayContentsTab())
    ...
    def testNonFolderishObjectDoesNotShowTab(self):
        ...
        view = getMultiAdapter((doc, self.app.REQUEST), name='plone')
        self.failIf(view.displayContentsTab())
    ...
    def testFolderishDefaultPageUsesParentPermissions(self):
        ...
        view = getMultiAdapter((def_page, self.app.REQUEST), name='plone')
        self.failUnless(view.displayContentsTab())
